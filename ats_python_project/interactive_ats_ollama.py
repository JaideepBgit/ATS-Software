"""
Interactive ATS - Chat with AI about candidates (Ollama Version)
...
# Import from advanced_ats (works with both LM Studio and Ollama configs)
from advanced_ats import AdvancedATS, ATSMatchResult


class InteractiveATSOllama(AdvancedATS):
    """Interactive ATS with conversational capabilities - Ollama version"""
    ...
    def ask_question(self, question: str) -> str:
        ...
        try:
            response = self.client.chat.completions.create(
                ...
                max_tokens=2000,
                extra_body={
                    "num_ctx": 8192  # Increased context window for better resume analysis
                }
            )
...
def main():
    """Main entry point"""
    print("\n" + "="*100)
    print("💬 INTERACTIVE ATS (OLLAMA) - Choose Your Mode")
    print("="*100)
